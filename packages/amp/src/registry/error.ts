...
export const DatasetConversionError = makeError("DATASET_CONVERSION_ERROR", "DatasetConversionError").annotate({
  httpApiStatus: 500
})
...
export const DatasetVersionNotFoundError = makeError("VERSION_NOT_FOUND", "DatasetVersionNotFoundError").annotate({
  httpApiStatus: 404
})

export type DatasetVersionNotFoundError = typeof DatasetVersionNotFoundError.Type

export const ForbiddenError = makeError("FORBIDDEN", "ForbiddenError").annotate({ httpApiStatus: 403 })
...
export const InvalidDatasetReferenceError = makeError("INVALID_REFERENCE", "InvalidDatasetReferenceError").annotate({
  httpApiStatus: 500
})
...
export const InvalidManifestHashError = makeError("INVALID_MANIFEST_HASH", "InvalidManifestHashError").annotate({
  httpApiStatus: 500
})

export type InvalidManifestHashError = typeof InvalidManifestHashError.Type

export const InvalidNamespaceError = makeError("INVALID_NAMESPACE", "InvalidNamespaceError").annotate({
  httpApiStatus: 400
})
...
export const InvalidPathParametersError = makeError("INVALID_PATH_PARAMETERS", "InvalidPathParametersError").annotate({
  httpApiStatus: 400
})

export type InvalidPathParametersError = typeof InvalidPathParametersError.Type

export const InvalidRequestBodyError = makeError("INVALID_REQUEST_BODY", "InvalidRequestBodyError").annotate({
  httpApiStatus: 400
})

export type InvalidRequestBodyError = typeof InvalidRequestBodyError.Type

export const InvalidSelectorError = makeError("INVALID_SELECTOR", "InvalidSelectorError").annotate({
  httpApiStatus: 400
})
...
export const ManifestRetrievalError = makeError("MANIFEST_RETRIEVAL_ERROR", "ManifestRetrievalError").annotate({
  httpApiStatus: 500
})

export type ManifestRetrievalError = typeof ManifestRetrievalError.Type

export const NamespaceAccessDeniedError = makeError("NAMESPACE_ACCESS_DENIED", "NamespaceAccessDeniedError").annotate({
  httpApiStatus: 403
})

export type NamespaceAccessDeniedError = typeof NamespaceAccessDeniedError.Type

export const RegistryDatabaseError = makeError("AMP_REGISTRY_DB_ERROR", "RegistryDatabaseError").annotate({
  httpApiStatus: 500
})
...
export const ServiceUnavailableError = makeError("SERVICE_UNAVAILABLE", "ServiceUnavailableError").annotate({
  httpApiStatus: 503
})
