 ...
 */
export const validatePrevHash = Effect.fnUntraced(function* (
  range: BlockRange
): Effect.fn.Return<void, MissingPrevHashError | InvalidPrevHashError> {
 ...
 * @returns An Effect that succeeds if valid, or fails with a validation error.
 */
export const validateNetworks = Effect.fnUntraced(function* (
 ...
 * @returns An Effect that succeeds if valid, or fails with a validation error.
 */
export const validateConsecutiveness = Effect.fnUntraced(function* (
  previous: ReadonlyArray<BlockRange>,
  incoming: ReadonlyArray<BlockRange>
