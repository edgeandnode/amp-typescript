 ...
 */
export class RpcError extends Schema.TaggedError<RpcError>("Amp/RpcError")("RpcError", {
 ...
 */
export class NoEndpointsError extends Schema.TaggedError<NoEndpointsError>("Amp/NoEndpointsError")("NoEndpointsError", {
  /**
 ...
 * of data.
 */
export class MultipleEndpointsError extends Schema.TaggedError<MultipleEndpointsError>("Amp/MultipleEndpointsError")(
  "MultipleEndpointsError",
  {
    /**
     * The SQL query that was requested.
 ...
 */
export class TicketNotFoundError extends Schema.TaggedError<TicketNotFoundError>("Amp/TicketNotFoundError")(
  "TicketNotFoundError",
  {
    /**
     * The SQL query that was requested.
 ...
 * Arrow RecordBatch.
 */
export class ParseRecordBatchError extends Schema.TaggedError<ParseRecordBatchError>("Amp/ParseRecordBatchError")(
  "ParseRecordBatchError",
  {
    /**
 ...
 * Arrow Schema.
 */
export class ParseSchemaError extends Schema.TaggedError<ParseSchemaError>("Amp/ParseSchemaError")("ParseSchemaError", {
  /**
