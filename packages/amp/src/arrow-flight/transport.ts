 ...
 */
export class Transport extends Context.Service<Transport, ConnectTransport>()("@edgeandnode/amp/Transport") {}
 ...
 */
export class Interceptors extends Context.Reference("Amp/ArrowFlight/ConnectRPC/Interceptors", {
  defaultValue: () => Arr.empty<Interceptor>()
}) {}

export const AuthInfoContextKey = createContextKey<AuthInfo | undefined>(undefined, {
