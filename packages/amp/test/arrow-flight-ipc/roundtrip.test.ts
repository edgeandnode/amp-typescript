...
describe("FlightData roundtrip", () => {
  it.effect("a simple int32 column", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().int32("id").build()
  ...
  it.effect("bool column", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().bool("flag").build()
  ...
  it.effect("utf8 column", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().utf8("name").build()
  ...
  it.effect("multiple columns", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().int32("id").utf8("name").bool("active").int64("score").build()
  ...
  it.effect("float types", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().float32("f32").float64("f64").build()
  ...
  it.effect("binary types", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().binary("bin").fixedSizeBinary("fixed", 8).build()
  ...
  it.effect("decimal type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().decimal("amount", 10, 2).build()
  ...
  it.effect("temporal types", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().dateDay("day").dateMillisecond("ms_date").timestamp("ts").build()
  ...
  it.effect("struct type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema()
        .struct("person", (b) => b.utf8("name").int32("age"))
        .build()
  ...
  it.effect("handles empty record batch (0 rows)", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().int32("id").utf8("name").bool("active").build()
  ...
  it.effect("handles empty strings (not null)", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().utf8("text").build()
  ...
  it.effect("handles empty binary (not null)", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().binary("data").build()
  ...
  it.effect("handles all-null columns", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().int32("id").utf8("name").build()
      ...
      const testSchema = SchemaBuilder.schema()
        .struct("outer", (s) =>
          s
            ...
            .struct("nested", (n) => n.int32("value").utf8("label"))
        )
        .build()
  ...
  it.effect("many small batches", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().int32("value").build()
  ...
  it.effect("multi-batch with complex nested types", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema()
        .int32("id")
        .list("tags", (b) => b.utf8())
        .struct("metadata", (s) => s.utf8("key").int32("count"))
        .build()
  ...
  it.effect("float32 with special values (NaN, Infinity, -0)", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().float32("value").build()
  ...
  it.effect("float64 with special values", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().float64("value").build()
  ...
  it.effect("float16 type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().float16("half").build()
  ...
  it.effect("large-utf8 type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().largeUtf8("bigText").build()
  ...
  it.effect("large-binary type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema().largeBinary("bigData").build()
  ...
  it.effect("sparse union type", ({ expect }) =>
    Effect.gen(function* () {
      const testSchema = SchemaBuilder.schema()
        .union("choice", "SPARSE", (u) => u.variant("intVal", (b) => b.int32()).variant("strVal", (b) => b.utf8()))
        .build()
