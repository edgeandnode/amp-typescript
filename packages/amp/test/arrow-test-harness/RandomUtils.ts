 ...
 */
export const nextFloat = (min: number, max: number): Effect.Effect<number> =>
  Effect.map(Random.next, (n) => n * (max - min) + min)

/**
 * Returns true with the given probability.
 */
export const nextBoolWithProbability = (probability: number): Effect.Effect<boolean> =>
 ...
 */
export const nextTimestampMs = (): Effect.Effect<number> => Random.nextIntBetween(0, 4102444800000)

/**
 * Generate a random time of day in milliseconds (0 to 86399999).
 */
export const nextTimeOfDayMs = (): Effect.Effect<number> => Random.nextIntBetween(0, 86399999)
 ...
 */
export const nextInt8 = (): Effect.Effect<number> => Random.nextIntBetween(-128, 127)

/**
 * Generate a random unsigned 8-bit integer.
 */
export const nextUint8 = (): Effect.Effect<number> => Random.nextIntBetween(0, 255)

/**
 * Generate a random signed 16-bit integer.
 */
export const nextInt16 = (): Effect.Effect<number> => Random.nextIntBetween(-32768, 32767)

/**
 * Generate a random unsigned 16-bit integer.
 */
export const nextUint16 = (): Effect.Effect<number> => Random.nextIntBetween(0, 65535)

/**
 * Generate a random signed 32-bit integer.
 */
export const nextInt32 = (): Effect.Effect<number> => Random.nextIntBetween(-2147483648, 2147483647)

/**
 * Generate a random unsigned 32-bit integer.
 */
export const nextUint32 = (): Effect.Effect<number> => Random.nextIntBetween(0, 4294967295)

/**
 * Generate a random signed 64-bit integer.
 */
export const nextInt64 = (): Effect.Effect<bigint> => nextBigInt(-9223372036854775808n, 9223372036854775807n)

/**
 * Generate a random unsigned 64-bit integer.
 */
export const nextUint64 = (): Effect.Effect<bigint> => nextBigInt(0n, 18446744073709551615n)

/**
 * Generate a random 32-bit float.
 */
export const nextFloat32 = (): Effect.Effect<number> => nextFloat(-3.4028235e38, 3.4028235e38)

/**
 * Generate a random 64-bit float.
 */
export const nextFloat64 = (): Effect.Effect<number> => nextFloat(-1e100, 1e100)
